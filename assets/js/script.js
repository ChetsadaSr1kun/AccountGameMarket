...
const marketplaceSearch = window.__marketplaceSearch || { listings: '', 'listings-user': '' };
window.__marketplaceSort = marketplaceSort; window.__marketplaceSearch = marketplaceSearch;
